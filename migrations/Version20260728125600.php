...
/**
 * Convertit MyISAM → InnoDB puis applique réellement les FOREIGN KEY
 * (la migration précédente était no-op sous MyISAM).
 */
final class Version20260728125600 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Conversion InnoDB + application réelle des FOREIGN KEY';
    }
